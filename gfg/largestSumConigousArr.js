...
function getResult(arr){
  var prevPosSum = 0,prevNegSum=0,currPosSum=0,currNegSum= 0,max = 0;
  var result = [];
  var index = 0;
  while(index<arr.length){
    ...
    max = Math.max(prevPosSum+prevNegSum+currPosSum,currPosSum,prevPosSum);
    prevPosSum = currPosSum;
    prevNegSum = currNegSum;
    // console.log("#",currPosSum,currNegSum,max);
